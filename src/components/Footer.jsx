    ...
    <footer className='relative pt-15 pb-2 bg-[#020F37] w-full text-white flex flex-col lg:items-center gap-5 lg:h-[60vh] lg:gap-20 lg:justify-center'>
      ...
      <div className='lg:w-[70%] pt-10 flex flex-col gap-20 lg:flex-row'>
        ...
        <div className="flex flex-col text-xs items-center">
          <img className='scale-45' src="\logo-white.png" alt="SVG Post logo" />
          <p className='opacity-70 -mt-3 lg:mt-8 mb-2'>St. Vincent & the Grenadines Postal Corporation</p>
          <p className='opacity-70'>Ground Floor, Ministerial Building, Kingstown</p>
        </div>
